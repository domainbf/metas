...
export const FeaturesSection: FC<FeaturesSectionProps> = (props) => (
  <section {...props}>
    <h2 className="mb-6 text-center text-3xl font-bold">
      Domain Met.as: The Essential Domain Information Tool
    </h2>
    ...
    <div className="mb-24 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
      <Card className="p-4">
        ...
        <p>
          Domain Met.as is an advanced, web-based tool designed to provide
      ...
      <Card className="p-4">
        ...
        <p>
          ...
          traditional tools that may cache DNS responses, Domain Met.as ensures
      ...
      <Card className="p-4">
        ...
        <p>
          Using Domain Met.as is straightforward. Simply enter a domain name,
      ...
      <Card className="p-4">
        ...
        <p>
          Domain Met.as offers the flexibility to select from a wide range of
      ...
      <Card className="p-4">
        ...
        <p>
          Domain Met.as is useful in various scenarios, such as verifying the
